...
## How to use
**Public URL: `https://streamprovider.byteful.me/`** <br><br>
Example Usage:
```
TV Show:
https://streamprovider.byteful.me/?tmdbId=246&season=2&episode=1
Movie:
https://streamprovider.byteful.me/?tmdbId=10681
```
